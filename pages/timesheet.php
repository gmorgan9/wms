  ...
  <!-- NON ADMIN TIMESHEET (LEFT SIDE) -->
    ...
    ?>
       ...
       <form method="post" action="">
            ...
            <button style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;" type="submit" name="create-timesheet"><span class="mx-auto badge text-bg-primary">Create Timesheet</span></button>
        </form>
        <?php } ?>
