    ...
    ?>
      <tr>
          ...
          <?php if($orgTimein == null && $orgTimeout == null) { ?>
            <td><span style="background: rgb(253,243,209); color: rgb(98,78,23); border-radius: 5px; border: none; padding: .35em; font-size: 10px;  outline: inherit;">Clock In</span></td>
