    ...
    ?>
      <tr>
          ...
          <?php if($orgTimein == null && $orgTimeout == null) { ?>
            <td><span class="badge text-bg-primary"><span style="background: rgb(253,243,209); color: rgb(98,78,23); border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;">Clock In</span></span></td>
