  ...
  <!-- NON ADMIN TIMESHEET (LEFT SIDE) -->
     ...
     <div class="page-content float-start" style="margin-top: 12px; width: 32%;margin-left: -100px; height: 250px; !important;">
       <div class="section-header pt-2">
         <span class="text-muted pt-4" style="width: 95%;">Time Entry</span><a class="float-end text-decoration-none text-muted" href="<?php $_SERVER['PHP_SELF']; ?>"><i class="bi bi-arrow-clockwise"></i></a>
       </div>
