...
// ADD SCHEDULE
  if(isset($_POST['add-schedule'])){
    ...
    $insert = "INSERT INTO schedule (idno, mon_date, mon_timein, mon_timeout, tues_date, tues_timein, tues_timeout, wed_date, wed_timein, wed_timeout, thurs_date, thurs_timein, thurs_timeout, fri_date, fri_timein, fri_timeout, notes, employee_fname, employee_lname, employee_idno, jobtitle, companyname, deptname) VALUES ('$idno', '$mon_date', NULLIF('$mon_timein', ''), NULLIF('$mon_timeout', ''), '$tues_date', NULLIF('$tues_timein', ''), NULLIF('$tues_timeout', ''), '$wed_date', NULLIF('$wed_timein', ''), NULLIF('$wed_timeout', ''), '$thurs_date', NULLIF('$thurs_timein', ''), NULLIF('$thurs_timeout', ''), '$fri_date', NULLIF('$fri_timein', ''), NULLIF('$fri_timeout', ''), NULLIF('$notes', ''), '$employee_fname', '$employee_lname', '$employee_idno', '$jobtitle', '$companyname', '$deptname')";
...
<!-- STAR MAIN -->
  ...
  <div class="page-header mx-auto">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo BASE_URL . '/pages/schedule.php' ?>">Schedules</a></li>
  ...
  <!-- START ADD COMPANY (LEFT SIDE) -->
    ...
    <div class="section-header text-center" style="margin-bottom: -10px;">
      <span style="font-size: 12px;" class="text-muted">If no desired schedule, leave time in and time out blank.</span>
    </div>
    <div class="row">
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
      ...
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        ...
        <input class="form-control" id="mon_timein" type="time" name="mon_timein" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        <label for="mon_timeout" style="font-size: 14px;">Monday Timeout</label>
        <input class="form-control" id="mon_timeout" type="time" name="mon_timeout" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
      ...
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        ...
        <input class="form-control" id="tues_timein" type="time" name="tues_timein" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        <label for="tues_timeout" style="font-size: 14px;">Tuesday Time out</label>
        <input class="form-control" id="tues_timeout" type="time" name="tues_timeout" value="">
      </div>
    </div>
    <div class="row">
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
      ...
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        ...
        <input class="form-control" id="wed_timein" type="time" name="wed_timein" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        <label for="wed_timeout" style="font-size: 14px;">Wednesday Timeout</label>
        <input class="form-control" id="wed_timeout" type="time" name="wed_timeout" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
      ...
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        ...
        <input class="form-control" id="thurs_timein" type="time" name="thurs_timein" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        <label for="thurs_timeout" style="font-size: 14px;">Thursday Time out</label>
        <input class="form-control" id="thurs_timeout" type="time" name="thurs_timeout" value="">
      </div>
    </div>
    <div class="row">
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
      ...
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        ...
        <input class="form-control" id="fri_timein" type="time" name="fri_timein" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 15%;">
        <label for="fri_timeout" style="font-size: 14px;">Friday Timeout</label>
        <input class="form-control" id="fri_timeout" type="time" name="fri_timeout" value="">
      </div>
      <div class="form-group pt-3 mx-auto" style="width: 48%;">
        <label for="notes" style="font-size: 14px;">Notes <span class="text-muted" style="font-size: 10px;">Give details about your schedule this week</span></label>
