                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        ?>
                        <?php if($row['new_date'] == null && $row['approval_status'] == 'approved') { ?>
                            <?php echo $date; ?>
                        <?php } else { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        ?>
                     <?php if($row['new_timein'] == null && $row['approval_status'] == 'approved') { ?>
                            <?php echo $timein; ?>
                        <?php } else { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        ?>
                    <?php if($row['new_timeout'] == null && $row['approval_status'] == 'approved') { ?>
                            <?php echo $timeout; ?>
                        <?php } else { ?>
