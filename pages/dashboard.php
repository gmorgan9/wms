      ...
      ?>
          ...
          <div class="col me-3 ms-3" style="height: 175px; background-color: #eee; border-radius: 15px;">
            <div class="col-content" style="padding-top: 10px;">
              ...
              <div class="col-content" style="margin-top: 25px !important; width: 150px !important; margin-left: -10px; padding-top: 12.5px; height: 160px; background-color: #eee; border-radius: 15px;">
