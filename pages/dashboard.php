          ...
          <div class="col" style="margin-top: 22.5px; height: 130px; background-color: #eee; border-radius: 15px;">
            ...
            <span style="padding-top: 10px;">
              ...
              <span class="float-end pe-3 mt-2 text-muted" style="font-size: 14px;">
                <a class="text-decoration-none text-muted" href="<?php echo BASE_URL . '/pages/timesheet.php' ?>">My Timecard <i class="bi bi-chevron-right text-muted" style=" background-color: white; border-radius: 100%; border: 1px solid grey; padding: 2px;"></i></a>
              </span>
          </div>
        </div>
