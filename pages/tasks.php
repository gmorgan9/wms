  ...
  <!-- START JOB-REQUEST (RIGHT SIDE) -->
    ...
    ?>
      <tr>
          ...
          <td>
            <div class="d-flex">
            <button data-bs-toggle="modal" data-bs-target="#edit_modal_<?php echo $taskID; ?>" style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;"><span class="badge text-bg-danger">Delete</span></button>
