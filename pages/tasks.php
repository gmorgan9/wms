  ...
  <!-- START JOB-REQUEST (RIGHT SIDE) -->
    ...
    ?>
      <tr>
          ...
          <td>
            <div class="d-flex">
                <button data-bs-id="<?php echo $row['taskID']; ?>"  style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;" type="submit"><span class="badge text-bg-success viewbtn">Edit</span></button>
                &nbsp;
