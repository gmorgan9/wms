...
<div class="page-content float-start" style="margin-top: 12px; width: 32%;margin-left: -101px; height: unset !important;">
  <form action="" method="post">
    ...
    <div class="form-group pt-3 mx-auto" style="width: 95%;">
      <label for="companyname" style="font-size: 14px;">Company Name <span class="text-muted" style="font-size: 10px;">e.g. "Apple Corporation"</span></label>
...
<div class="page-content mt-2 float-end" style="width: 65%; margin-right: 10px;">
  ...
  ?>
    <tr>
        ...
        <td><?php //echo $czip; ?></td> -->
        <td><a style="text-decoration: none;" data-bs-toggle="modal" data-bs-target="#confirmDelete" class="badge text-bg-danger" href="companies.php?companyID=<?php echo $id; ?>">Delete</a></td>
        <?php } ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
          ...
          $new = "SELECT * FROM company where idno = '$idno'";
      ...
      <div class="modal-footer">
        ...
        <a class="badge text-bg-danger" style="text-decoration: none; cursor: pointer;" href="companies.php?companyID=<?php echo $id; ?>">Delete</a>
