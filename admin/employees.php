       ...
       <br>
        ...
        <div class="conatiner">
          <div class="row">
            ...
            <?php 
            $id = $_GET['employeeID'];
            $new = " SELECT employee.*, employee_company_data.*, company.* FROM employee INNER JOIN employee_company_data ON employee.employeeID = employee_company_data.employee_code INNER JOIN company ON company.cdataID = employee_company_data.cdataID WHERE employee.employeeID = '$empID'; ";
