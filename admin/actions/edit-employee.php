...
?>
  ...
  <div class="page-content" style="float: left;margin-top: 12px; width: 50%; margin-left: -55px;">
...
<div class="page-content mt-2 float-end" style="width: 50%; margin-right: 10px;">
<form action="" method="post">
