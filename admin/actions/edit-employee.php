...
?>
  ...
  <div class="page-content" style="float: left;margin-top: 12px; width: 48%; margin-left: -55px;">
...
<div class="page-content mt-2 float-end" style="width: 48%; margin-right: 10px;">
<form action="" method="post">
